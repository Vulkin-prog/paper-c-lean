...
| companion | [F.6](../manuscripts/v3prel8/companion/F_microscopic_pivots.tex#L316) | `supp:pivot:prop:footprint` | new statement open |
...
- **Microscopic signed prefix field**: Largest-odd-prime reciprocal estimate, directed footprint, exact arithmetic forcing, finite categorical ledger, independent tails, asymptotic completion and dyadic restriction.
