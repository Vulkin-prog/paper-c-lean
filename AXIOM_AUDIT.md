...
- Note historique de clôture : [`literature_certificates/HK13-QO-conductor-fibres.md`](literature_certificates/HK13-QO-conductor-fibres.md), SHA-256 `343743b60ffba701f1184ea8debf583443394ecb3789eaf1673e602a9ebf4c5f`, 3178 octets.
...
| `PaperC.Affine.RelationalPrimeAssignment.dvd_of_parityVec_ne_zero` | inconditionnel | — | — | — | `PaperC/Affine/RelationalPrimeAssignment.lean:157` |
| `PaperC.Affine.RelationalPrimeAssignment.existsUnique_opposite_for_largeKernel_of_left` | inconditionnel | — | — | — | `PaperC/Affine/RelationalPrimeAssignment.lean:338` |
| `PaperC.Affine.RelationalPrimeAssignment.existsUnique_opposite_for_largeKernel_of_right` | inconditionnel | — | — | — | `PaperC/Affine/RelationalPrimeAssignment.lean:372` |
| `PaperC.Affine.RelationalPrimeAssignment.existsUnique_opposite_of_left` | inconditionnel | — | — | — | `PaperC/Affine/RelationalPrimeAssignment.lean:212` |
| `PaperC.Affine.RelationalPrimeAssignment.existsUnique_opposite_of_right` | inconditionnel | — | — | — | `PaperC/Affine/RelationalPrimeAssignment.lean:272` |
| `PaperC.Affine.RelationalPrimeAssignment.parityVec_ne_zero_unique_in_start` | inconditionnel | — | — | — | `PaperC/Affine/RelationalPrimeAssignment.lean:169` |
| `PaperC.Affine.RelationalPrimeAssignment.relation_boundary_prime_equation` | inconditionnel | — | — | — | `PaperC/Affine/RelationalPrimeAssignment.lean:90` |
| `PaperC.Affine.RelationalPrimeAssignment.relation_prime_equation` | inconditionnel | — | — | — | `PaperC/Affine/RelationalPrimeAssignment.lean:54` |
| `PaperC.Affine.RelationalPrimeAssignment.startCompleteVertexLabel_dist_lt` | inconditionnel | — | — | — | `PaperC/Affine/RelationalPrimeAssignment.lean:125` |
| `PaperC.Affine.RelationalPrimeAssignment.startCompleteVertexLabel_injective` | inconditionnel | — | — | — | `PaperC/Affine/RelationalPrimeAssignment.lean:103` |
| `PaperC.Affine.StartDefectRank.card_startDefectIndices_le` | inconditionnel | — | — | — | `PaperC/Affine/StartDefectRank.lean:413` |
| `PaperC.Affine.StartDefectRank.relationRho_startSystem_le_card_defectsInInterval` | inconditionnel | — | — | — | `PaperC/Affine/StartDefectRank.lean:459` |
| `PaperC.Affine.StartDefectRank.startDefectRestriction_injective` | inconditionnel | — | — | — | `PaperC/Affine/StartDefectRank.lean:383` |
...
| `PaperC.Affine.StartDefectRank.startInteriorBoundary_eq_zero_of_not_hDefective` | inconditionnel | — | — | — | `PaperC/Affine/StartDefectRank.lean:225` |
| `PaperC.Affine.StartDefectRank.startInteriorBoundary_injective` | inconditionnel | — | — | — | `PaperC/Affine/StartDefectRank.lean:69` |
| `PaperC.Affine.TouchingDefectRank.card_touchingDefectIndices_le` | inconditionnel | — | — | — | `PaperC/Affine/TouchingDefectRank.lean:869` |
| `PaperC.Affine.TouchingDefectRank.relationRho_touchingSystem_le_card_defectsInInterval` | inconditionnel | — | — | — | `PaperC/Affine/TouchingDefectRank.lean:944` |
| `PaperC.Affine.TouchingDefectRank.touchingDefectRestriction_injective` | inconditionnel | — | — | — | `PaperC/Affine/TouchingDefectRank.lean:835` |
...
| `PaperC.Affine.TouchingDefectRank.touchingInteriorBoundary_eq_zero_of_not_hDefective` | inconditionnel | — | — | — | `PaperC/Affine/TouchingDefectRank.lean:683` |
...
| `PaperC.Affine.abs_eta_mul_two_pow_rho_sub_one_le` | inconditionnel | — | — | — | `PaperC/Affine/Normalization.lean:269` |
...
| `PaperC.Affine.affineFiber_normalized_card_identity` | inconditionnel | — | — | — | `PaperC/Affine/Normalization.lean:229` |
...
| `PaperC.Affine.card_pi_f2` | inconditionnel | — | — | — | `PaperC/Affine/Normalization.lean:221` |
...
| `PaperC.Affine.compatible_of_relationCharacter_eq_zero` | inconditionnel | — | — | — | `PaperC/Affine/Normalization.lean:176` |
...
| `PaperC.Affine.relationCharacter_eq_zero_iff_compatible` | inconditionnel | — | — | — | `PaperC/Affine/Normalization.lean:200` |
...
| `PaperC.Affine.relationEta_eq_one_iff_compatible` | inconditionnel | — | — | — | `PaperC/Affine/Normalization.lean:207` |
| `PaperC.Affine.relationEta_eq_zero_iff` | inconditionnel | — | — | — | `PaperC/Affine/Normalization.lean:75` |
| `PaperC.Affine.relationEta_eq_zero_iff_not_compatible` | inconditionnel | — | — | — | `PaperC/Affine/Normalization.lean:214` |
...
| `PaperC.Affine.relationRho_pos_of_character_ne_zero` | inconditionnel | — | — | — | `PaperC/Affine/Normalization.lean:256` |
| `PaperC.Affine.relationSignedSum_eq_eta_mul_two_pow_rho` | inconditionnel | — | — | — | `PaperC/Affine/Normalization.lean:155` |
| `PaperC.Affine.relationSignedSum_eq_ite` | inconditionnel | — | — | — | `PaperC/Affine/Normalization.lean:136` |
...
| `PaperC.AlignedComponentCode.componentCode_finrank_ge` | inconditionnel | — | — | — | `PaperC/Coding/AlignedComponentCode.lean:114` |
| `PaperC.AlignedComponentCode.componentLeftCount_add_rightCount` | inconditionnel | — | — | — | `PaperC/Coding/AlignedComponentCode.lean:71` |
| `PaperC.AlignedComponentCode.kernelWord_componentProducts_square` | inconditionnel | — | — | — | `PaperC/Coding/AlignedComponentCode.lean:190` |
| `PaperC.AlignedComponentCode.kernelWord_leftCount_even` | inconditionnel | — | — | — | `PaperC/Coding/AlignedComponentCode.lean:127` |
| `PaperC.AlignedComponentCode.kernelWord_parity_package` | inconditionnel | — | — | — | `PaperC/Coding/AlignedComponentCode.lean:237` |
| `PaperC.AlignedComponentCode.kernelWord_rightCount_even` | inconditionnel | — | — | — | `PaperC/Coding/AlignedComponentCode.lean:157` |
...
| `PaperC.BoundedRatioTerminalClosure.card_firstStarts_le_twice_possibleKernelValues` | inconditionnel | — | — | — | `PaperC/Asymptotics/BoundedRatioTerminalClosure.lean:334` |
...
| `PaperC.BoundedRatioTerminalClosure.card_possibleKernelValues_fourth_power_le` | inconditionnel | — | — | — | `PaperC/Asymptotics/BoundedRatioTerminalClosure.lean:395` |
| `PaperC.BoundedRatioTerminalClosure.card_possibleKernelValues_uniformThreeQuarter` | inconditionnel | — | — | — | `PaperC/Asymptotics/BoundedRatioTerminalClosure.lean:577` |
...
| `PaperC.BoundedRatioTerminalClosure.exp_eight_sqrt_runLength_uniformSubpolynomial` | inconditionnel | — | — | — | `PaperC/Asymptotics/BoundedRatioTerminalClosure.lean:512` |
| `PaperC.BoundedRatioTerminalClosure.kernelThreshold_sq_le_four_mul_determinantBudget` | inconditionnel | — | — | — | `PaperC/Asymptotics/BoundedRatioTerminalClosure.lean:367` |
...
| `PaperC.BoundedRatioTerminalClosure.rankTerminalSector_uniformLittleO_of_card_envelope` | inconditionnel | — | — | — | `PaperC/Asymptotics/BoundedRatioTerminalClosure.lean:600` |
...
| `PaperC.BoundedRatioTerminalClosure.terminalKernelCountResidual_uniformSubpolynomial` | inconditionnel | — | — | — | `PaperC/Asymptotics/BoundedRatioTerminalClosure.lean:547` |
| `PaperC.BoundedRatioTerminalClosure.uniformRationalPower_of_fourth_bound` | inconditionnel | — | — | — | `PaperC/Asymptotics/BoundedRatioTerminalClosure.lean:478` |
...
| `PaperC.CanonicalSmallRows.canonicalArithmeticKernelEquivalence_of_choice_none` | inconditionnel | — | — | — | `PaperC/LinearAlgebra/CanonicalSmallRows.lean:1182` |
| `PaperC.CanonicalSmallRows.canonicalArithmeticKernelStatement` | inconditionnel | — | — | — | `PaperC/LinearAlgebra/CanonicalSmallRows.lean:1207` |
| `PaperC.CanonicalSmallRows.canonicalArithmeticSmallRowMatrixRaw_mulVec` | inconditionnel | — | — | — | `PaperC/LinearAlgebra/CanonicalSmallRows.lean:650` |
...
| `PaperC.CanonicalSmallRows.canonicalArithmeticSmallRowMatrix_mulVec_block` | inconditionnel | — | — | — | `PaperC/LinearAlgebra/CanonicalSmallRows.lean:705` |
| `PaperC.CanonicalSmallRows.canonicalArithmeticSmallRowMatrix_mulVec_prime` | inconditionnel | — | — | — | `PaperC/LinearAlgebra/CanonicalSmallRows.lean:675` |
...
| `PaperC.CanonicalSmallRows.canonicalCoreBoundarySynthesis_relationToCoordinates_of_choice_none` | inconditionnel | — | — | — | `PaperC/LinearAlgebra/CanonicalSmallRows.lean:1038` |
...
| `PaperC.CanonicalSmallRows.canonicalSmallRowPresentation_of_arithmeticKernel` | conditionnel | `PCv07c-L9.10-arithmetic-kernel-equivalence` | `internal` | `discharged` | `PaperC/LinearAlgebra/CanonicalSmallRows.lean:1220` |
...
| `PaperC.CanonicalSmallRows.existsUnique_twoStartCompleteBoundary_eq_of_blockRows` | inconditionnel | — | — | — | `PaperC/LinearAlgebra/CanonicalSmallRows.lean:739` |
| `PaperC.CanonicalSmallRows.finrank_canonicalCoreCoordinates_eq_largePrimeSolution_of_choice_none` | inconditionnel | — | — | — | `PaperC/LinearAlgebra/CanonicalSmallRows.lean:980` |
...
| `PaperC.CanonicalSmallRows.mem_kernel_iff_existsUnique_relation_boundary` | inconditionnel | — | — | — | `PaperC/LinearAlgebra/CanonicalSmallRows.lean:802` |
| `PaperC.CanonicalSmallRows.primeBoundaryRow_apply` | inconditionnel | — | — | — | `PaperC/LinearAlgebra/CanonicalSmallRows.lean:467` |
| `PaperC.CanonicalSmallRows.primeBoundaryRow_eq_zero_of_mem_largePrimeSolution` | inconditionnel | — | — | — | `PaperC/LinearAlgebra/CanonicalSmallRows.lean:778` |
| `PaperC.CanonicalSmallRows.relationToCanonicalArithmeticKernel_of_choice_none_injective` | inconditionnel | — | — | — | `PaperC/LinearAlgebra/CanonicalSmallRows.lean:1095` |
| `PaperC.CanonicalSmallRows.relationToCanonicalArithmeticKernel_of_choice_none_surjective` | inconditionnel | — | — | — | `PaperC/LinearAlgebra/CanonicalSmallRows.lean:1126` |
| `PaperC.CanonicalSmallRows.residualTau_eq_corrected_add_components_sub_arithmeticRank` | conditionnel | `PCv07c-L9.10-arithmetic-kernel-equivalence` | `internal` | `discharged` | `PaperC/LinearAlgebra/CanonicalSmallRows.lean:1245` |
| `PaperC.CanonicalSmallRows.residualTau_eq_corrected_add_components_sub_arithmeticRank_of_choice_none` | inconditionnel | — | — | — | `PaperC/LinearAlgebra/CanonicalSmallRows.lean:1275` |
...
| `PaperC.ConditionalDependencyGraph.card_jointConditionedStartSolutions_mul_two_pow` | inconditionnel | — | — | — | `PaperC/Probability/ConditionalDependencyGraph.lean:718` |
...
| `PaperC.ConditionalDependencyGraph.conditionedStart_independent_of_nonNeighbors` | inconditionnel | — | — | — | `PaperC/Probability/ConditionalDependencyGraph.lean:428` |
...
| `PaperC.ConditionalDependencyGraph.goodStart_independent_of_graph_nonNeighbors` | inconditionnel | — | — | — | `PaperC/Probability/ConditionalDependencyGraph.lean:528` |
| `PaperC.ConditionalDependencyGraph.jointConditionedStartProbability_eq_baseline` | inconditionnel | — | — | — | `PaperC/Probability/ConditionalDependencyGraph.lean:792` |
| `PaperC.ConditionalDependencyGraph.jointConditionedStartProbability_eq_product` | inconditionnel | — | — | — | `PaperC/Probability/ConditionalDependencyGraph.lean:837` |
| `PaperC.ConditionalDependencyGraph.jointConditionedSystem_eq_iff_forall_startAt` | inconditionnel | — | — | — | `PaperC/Probability/ConditionalDependencyGraph.lean:596` |
| `PaperC.ConditionalDependencyGraph.jointLargeStartSystem_apply` | inconditionnel | — | — | — | `PaperC/Probability/ConditionalDependencyGraph.lean:585` |
| `PaperC.ConditionalDependencyGraph.jointLargeStartSystem_surjective` | inconditionnel | — | — | — | `PaperC/Probability/ConditionalDependencyGraph.lean:637` |
...
| `PaperC.ConditionalDependencyGraph.largeStartSystem_surjective_of_mem_goodStarts` | inconditionnel | — | — | — | `PaperC/Probability/ConditionalDependencyGraph.lean:614` |
...
| `PaperC.ConditionalStartProbability.assemble_restrictions` | inconditionnel | — | — | — | `PaperC/Probability/ConditionalStartProbability.lean:164` |
| `PaperC.ConditionalStartProbability.assemble_solves_start_iff` | inconditionnel | — | — | — | `PaperC/Probability/ConditionalStartProbability.lean:208` |
| `PaperC.ConditionalStartProbability.assemble_startAt_iff` | inconditionnel | — | — | — | `PaperC/Probability/ConditionalStartProbability.lean:221` |
| `PaperC.ConditionalStartProbability.card_conditionedStartSolutions_mul_two_pow` | inconditionnel | — | — | — | `PaperC/Probability/ConditionalStartProbability.lean:536` |
| `PaperC.ConditionalStartProbability.conditionedStartProbability_eq_baseline` | inconditionnel | — | — | — | `PaperC/Probability/ConditionalStartProbability.lean:585` |
| `PaperC.ConditionalStartProbability.conditionedStartProbability_eq_baseline_of_not_terminalBad` | inconditionnel | — | — | — | `PaperC/Probability/ConditionalStartProbability.lean:627` |
| `PaperC.ConditionalStartProbability.largeStartSystem_surjective` | inconditionnel | — | — | — | `PaperC/Probability/ConditionalStartProbability.lean:487` |
| `PaperC.ConditionalStartProbability.relationSpace_largeStartSystem_eq_bot` | inconditionnel | — | — | — | `PaperC/Probability/ConditionalStartProbability.lean:365` |
| `PaperC.ConditionalStartProbability.restrictLarge_assemble` | inconditionnel | — | — | — | `PaperC/Probability/ConditionalStartProbability.lean:158` |
| `PaperC.ConditionalStartProbability.restrictLarge_extendLarge` | inconditionnel | — | — | — | `PaperC/Probability/ConditionalStartProbability.lean:144` |
| `PaperC.ConditionalStartProbability.restrictLarge_extendSmall` | inconditionnel | — | — | — | `PaperC/Probability/ConditionalStartProbability.lean:137` |
| `PaperC.ConditionalStartProbability.restrictSmall_assemble` | inconditionnel | — | — | — | `PaperC/Probability/ConditionalStartProbability.lean:152` |
| `PaperC.ConditionalStartProbability.restrictSmall_extendLarge` | inconditionnel | — | — | — | `PaperC/Probability/ConditionalStartProbability.lean:130` |
...
| `PaperC.DefectFirstMoment.abs_dyadicExpectation_sub_baseline_le` | inconditionnel | — | — | — | `PaperC/Probability/DefectFirstMoment.lean:123` |
| `PaperC.DefectFirstMoment.abs_dyadicExpectation_sub_baseline_le_globalDefectWeight` | inconditionnel | — | — | — | `PaperC/Probability/DefectFirstMoment.lean:180` |
| `PaperC.DefectFirstMoment.abs_dyadicExpectation_sub_baseline_le_weight` | inconditionnel | — | — | — | `PaperC/Probability/DefectFirstMoment.lean:149` |
| `PaperC.DefectFirstMoment.abs_startProbability_sub_baseline_le` | inconditionnel | — | — | — | `PaperC/Probability/DefectFirstMoment.lean:90` |
...
| `PaperC.FiniteCylinderCountTransport.boundedBadStartProbabilityMass_le_two_cutoffs` | inconditionnel | — | — | — | `PaperC/Probability/FiniteCylinderCountTransport.lean:685` |
| `PaperC.FiniteCylinderCountTransport.boundedFullStartMean_eq_goodParameter_add_badMass` | inconditionnel | — | — | — | `PaperC/Probability/FiniteCylinderCountTransport.lean:639` |
| `PaperC.FiniteCylinderCountTransport.boundedStartProbability_eq_baseline_of_not_bad` | inconditionnel | — | — | — | `PaperC/Probability/FiniteCylinderCountTransport.lean:607` |
| `PaperC.FiniteCylinderCountTransport.boundedStartProbability_eq_selfStartProbability` | inconditionnel | — | — | — | `PaperC/Probability/FiniteCylinderCountTransport.lean:517` |
| `PaperC.FiniteCylinderCountTransport.boundedStartProbability_le_two_mul_defectWeight_div` | inconditionnel | — | — | — | `PaperC/Probability/FiniteCylinderCountTransport.lean:578` |
| `PaperC.FiniteCylinderCountTransport.boundedTerminalBadStarts_mono` | inconditionnel | — | — | — | `PaperC/Probability/FiniteCylinderCountTransport.lean:553` |
| `PaperC.FiniteCylinderCountTransport.disagreementProbability_boundedGood_full_le_badMass` | inconditionnel | — | — | — | `PaperC/Probability/FiniteCylinderCountTransport.lean:801` |
| `PaperC.FiniteCylinderCountTransport.exists_bad_start_of_boundedGood_ne_full` | inconditionnel | — | — | — | `PaperC/Probability/FiniteCylinderCountTransport.lean:779` |
| `PaperC.FiniteCylinderCountTransport.finiteNatLaw_startCountOn_cutoff_invariant` | inconditionnel | — | — | — | `PaperC/Probability/FiniteCylinderCountTransport.lean:401` |
| `PaperC.FiniteCylinderCountTransport.natTotalVariation_boundedGood_full_le_badMass` | inconditionnel | — | — | — | `PaperC/Probability/FiniteCylinderCountTransport.lean:884` |
| `PaperC.FiniteCylinderCountTransport.startAt_assemble_iff_local` | inconditionnel | — | — | — | `PaperC/Probability/FiniteCylinderCountTransport.lean:183` |
| `PaperC.FiniteCylinderCountTransport.startAt_sampleSpaceEquivLocalProd_iff` | inconditionnel | — | — | — | `PaperC/Probability/FiniteCylinderCountTransport.lean:229` |
| `PaperC.FiniteCylinderCountTransport.startCountOn_sampleSpaceEquivLocalProd` | inconditionnel | — | — | — | `PaperC/Probability/FiniteCylinderCountTransport.lean:329` |
| `PaperC.FiniteCylinderCountTransport.uniformEventProbability_startAt_cutoff_invariant` | inconditionnel | — | — | — | `PaperC/Probability/FiniteCylinderCountTransport.lean:245` |
| `PaperC.FiniteCylinderCountTransport.valueBit_assemble_eq_local` | inconditionnel | — | — | — | `PaperC/Probability/FiniteCylinderCountTransport.lean:148` |
...
| `PaperC.IndependentThinning.bOne_thinnedIndicator_le` | inconditionnel | — | — | — | `PaperC/Probability/IndependentThinning.lean:899` |
| `PaperC.IndependentThinning.bTwo_thinnedIndicator_le` | inconditionnel | — | — | — | `PaperC/Probability/IndependentThinning.lean:931` |
...
| `PaperC.IndependentThinning.eventProbability_coordinateEvent_and_of_disjoint` | inconditionnel | — | — | — | `PaperC/Probability/IndependentThinning.lean:398` |
| `PaperC.IndependentThinning.eventProbability_coordinateEvent_eq_prod` | inconditionnel | — | — | — | `PaperC/Probability/IndependentThinning.lean:319` |
| `PaperC.IndependentThinning.eventProbability_coordinate_true` | inconditionnel | — | — | — | `PaperC/Probability/IndependentThinning.lean:462` |
| `PaperC.IndependentThinning.eventProbability_no_thinned_active_eq_exponentialFunctional` | inconditionnel | — | — | — | `PaperC/Probability/IndependentThinning.lean:967` |
...
| `PaperC.IndependentThinning.eventProbability_two_coordinates_true` | inconditionnel | — | — | — | `PaperC/Probability/IndependentThinning.lean:475` |
...
| `PaperC.IndependentThinning.hasExactDependencyGraph_combineIndicator` | inconditionnel | — | — | — | `PaperC/Probability/IndependentThinning.lean:601` |
| `PaperC.IndependentThinning.hasExactDependencyGraph_coordinateIndicator` | inconditionnel | — | — | — | `PaperC/Probability/IndependentThinning.lean:524` |
| `PaperC.IndependentThinning.hasExactDependencyGraph_thinnedIndicator` | inconditionnel | — | — | — | `PaperC/Probability/IndependentThinning.lean:795` |
| `PaperC.IndependentThinning.jointMarginal_thinnedIndicator` | inconditionnel | — | — | — | `PaperC/Probability/IndependentThinning.lean:857` |
| `PaperC.IndependentThinning.marginal_thinnedIndicator` | inconditionnel | — | — | — | `PaperC/Probability/IndependentThinning.lean:823` |
| `PaperC.IndependentThinning.mem_outsideVertices` | inconditionnel | — | — | — | `PaperC/Probability/IndependentThinning.lean:503` |
| `PaperC.IndependentThinning.thinnedIndicator_eq_true_iff` | inconditionnel | — | — | — | `PaperC/Probability/IndependentThinning.lean:784` |
...
| `PaperC.LowZonePrimePivots.card_intermediatePrimes_le` | inconditionnel | — | — | — | `PaperC/Arithmetic/LowZonePrimePivots.lean:509` |
...
| `PaperC.LowZonePrimePivots.lowZoneConstraintMap_evenPrimeTestVector` | inconditionnel | — | — | — | `PaperC/Arithmetic/LowZonePrimePivots.lean:448` |
| `PaperC.LowZonePrimePivots.lowZoneConstraintMap_rightInverse` | inconditionnel | — | — | — | `PaperC/Arithmetic/LowZonePrimePivots.lean:478` |
| `PaperC.LowZonePrimePivots.lowZoneConstraintMap_surjective` | inconditionnel | — | — | — | `PaperC/Arithmetic/LowZonePrimePivots.lean:500` |
| `PaperC.LowZonePrimePivots.lowZoneSquareLabel_lt` | inconditionnel | — | — | — | `PaperC/Arithmetic/LowZonePrimePivots.lean:280` |
| `PaperC.LowZonePrimePivots.lowZoneSquareOffset_pos_le` | inconditionnel | — | — | — | `PaperC/Arithmetic/LowZonePrimePivots.lean:229` |
| `PaperC.LowZonePrimePivots.lowZoneSquareVertex_not_mem` | inconditionnel | — | — | — | `PaperC/Arithmetic/LowZonePrimePivots.lean:290` |
...
| `PaperC.LowZonePrimePivots.parityVec_eq_zero_of_not_mem_primeVertexSet` | inconditionnel | — | — | — | `PaperC/Arithmetic/LowZonePrimePivots.lean:367` |
| `PaperC.LowZonePrimePivots.parityVec_lowZoneSquareVertex` | inconditionnel | — | — | — | `PaperC/Arithmetic/LowZonePrimePivots.lean:401` |
| `PaperC.LowZonePrimePivots.parityVec_primePivot` | inconditionnel | — | — | — | `PaperC/Arithmetic/LowZonePrimePivots.lean:380` |
| `PaperC.LowZonePrimePivots.primePivot_mem` | inconditionnel | — | — | — | `PaperC/Arithmetic/LowZonePrimePivots.lean:360` |
...
| `PaperC.LowZonePrimePivots.relationRho_startSystem_le_sub_card_intermediatePrimes` | inconditionnel | — | — | — | `PaperC/Arithmetic/LowZonePrimePivots.lean:681` |
| `PaperC.LowZonePrimePivots.relation_boundary_constraint_eq_zero` | inconditionnel | — | — | — | `PaperC/Arithmetic/LowZonePrimePivots.lean:639` |
| `PaperC.LowZonePrimePivots.sqrt_window_le_of_gap` | inconditionnel | — | — | — | `PaperC/Arithmetic/LowZonePrimePivots.lean:537` |
...
| `PaperC.LowZonePrimePivots.startProbability_le_inv_two_pow_card_intermediatePrimes` | inconditionnel | — | — | — | `PaperC/Arithmetic/LowZonePrimePivots.lean:758` |
...
| `PaperC.PellInput.quadraticOrderConductorFiberBound` | inconditionnel | — | — | — | `PaperC/Diophantine/HalterKochConductorDescent.lean:649` |
| `PaperC.PellInput.quadraticOrderConductorFiberBound_of_halterKochConductorDescent` | inconditionnel | — | — | — | `PaperC/Diophantine/HalterKochConductorDescent.lean:190` |
...
| `PaperC.PrivatePivots.not_dvd_of_dvd_and_dist_lt` | inconditionnel | — | — | — | `PaperC/LinearAlgebra/PrivatePivots.lean:236` |
| `PaperC.PrivatePivots.parityVecAbove_apply` | inconditionnel | — | — | — | `PaperC/LinearAlgebra/PrivatePivots.lean:308` |
...
| `PaperC.PrivatePivots.tree_parityEdge_linearIndependent_of_large_odd_primes` | inconditionnel | — | — | — | `PaperC/LinearAlgebra/PrivatePivots.lean:260` |
| `PaperC.PrivatePivots.tree_projectedParityEdge_linearIndependent_of_large_odd_primes` | inconditionnel | — | — | — | `PaperC/LinearAlgebra/PrivatePivots.lean:316` |
...
| `PaperC.QuadraticIdealDivisors.factorCountProduct_primeFactors_assembly` | inconditionnel | — | — | — | `PaperC/Diophantine/QuadraticIdealDivisors.lean:396` |
| `PaperC.QuadraticIdealDivisors.factorCountProduct_rationalPrimePowerIdeal_le` | inconditionnel | — | — | — | `PaperC/Diophantine/QuadraticIdealDivisors.lean:419` |
| `PaperC.QuadraticIdealDivisors.factorCountProduct_span_natCast_le_tauSq` | inconditionnel | — | — | — | `PaperC/Diophantine/QuadraticIdealDivisors.lean:445` |
| `PaperC.QuadraticIdealDivisors.factorCountProduct_span_natPrime_pow_le` | inconditionnel | — | — | — | `PaperC/Diophantine/QuadraticIdealDivisors.lean:337` |
| `PaperC.QuadraticIdealDivisors.factorization_ne_zero_of_mem_primeFactors` | inconditionnel | — | — | — | `PaperC/Diophantine/QuadraticIdealDivisors.lean:363` |
...
| `PaperC.QuadraticIdealDivisors.natCard_idealDivisors_span_natCast_le_tauSq` | inconditionnel | — | — | — | `PaperC/Diophantine/QuadraticIdealDivisors.lean:472` |
| `PaperC.QuadraticIdealDivisors.prod_factorCountProduct_rationalPrimePowerIdeal_le` | inconditionnel | — | — | — | `PaperC/Diophantine/QuadraticIdealDivisors.lean:430` |
| `PaperC.QuadraticIdealDivisors.quadraticIdealDivisorTauSq` | inconditionnel | — | — | — | `PaperC/Diophantine/QuadraticIdealDivisors.lean:498` |
| `PaperC.QuadraticIdealDivisors.rationalPrimePowerIdeal_isCoprime` | inconditionnel | — | — | — | `PaperC/Diophantine/QuadraticIdealDivisors.lean:379` |
| `PaperC.QuadraticIdealDivisors.rationalPrimePowerIdeal_ne_bot` | inconditionnel | — | — | — | `PaperC/Diophantine/QuadraticIdealDivisors.lean:370` |
...
| `PaperC.QuadraticIdealDivisors.span_natCast_eq_prod_rationalPrimePowerIdeal` | inconditionnel | — | — | — | `PaperC/Diophantine/QuadraticIdealDivisors.lean:411` |
...
| `PaperC.SectionElevenPartition.existsUnique_sector` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:273` |
| `PaperC.SectionElevenPartition.lemma_eleven_one_existsUnique_sector` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:725` |
| `PaperC.SectionElevenPartition.lemma_eleven_one_populations_cover` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:700` |
| `PaperC.SectionElevenPartition.mem_sectionElevenSectorPairs` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:424` |
| `PaperC.SectionElevenPartition.mem_sectorPopulation` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:225` |
| `PaperC.SectionElevenPartition.not_atLeastThreeCorrectedDefects_iff_atMostTwo` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:373` |
| `PaperC.SectionElevenPartition.not_isCanonicallyAligned_iff_nonaligned` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:341` |
| `PaperC.SectionElevenPartition.not_isCanonicallyNonaligned_iff_aligned` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:352` |
| `PaperC.SectionElevenPartition.not_smallCanonicalPrimeProduct_iff_large` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:315` |
| `PaperC.SectionElevenPartition.sectionElevenSectorOf_eq_five_iff` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:489` |
| `PaperC.SectionElevenPartition.sectionElevenSectorOf_eq_four_iff` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:473` |
| `PaperC.SectionElevenPartition.sectionElevenSectorOf_eq_one_iff` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:437` |
| `PaperC.SectionElevenPartition.sectionElevenSectorOf_eq_seven_iff` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:526` |
| `PaperC.SectionElevenPartition.sectionElevenSectorOf_eq_six_iff` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:507` |
| `PaperC.SectionElevenPartition.sectionElevenSectorOf_eq_three_iff` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:459` |
| `PaperC.SectionElevenPartition.sectionElevenSectorOf_eq_two_iff` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:447` |
| `PaperC.SectionElevenPartition.sectionElevenSectorPairs_disjoint` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:686` |
| `PaperC.SectionElevenPartition.sectionElevenSectorPairs_one_eq_smallProductPairs` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:550` |
| `PaperC.SectionElevenPartition.sectionElevenSectorPairs_three_eq_shallowCorePairs` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:579` |
| `PaperC.SectionElevenPartition.sectionElevenSectorPairs_two_eq_smallHeightLargeProductPairs` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:564` |
| `PaperC.SectionElevenPartition.sectionEleven_lateSectors_eq_deepCorePairs` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:595` |
| `PaperC.SectionElevenPartition.sectorOf_eq_alignedDeepCore_iff` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:144` |
| `PaperC.SectionElevenPartition.sectorOf_eq_manyDefects_iff` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:161` |
| `PaperC.SectionElevenPartition.sectorOf_eq_nonterminal_iff` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:179` |
| `PaperC.SectionElevenPartition.sectorOf_eq_shallowCore_iff` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:128` |
| `PaperC.SectionElevenPartition.sectorOf_eq_smallCanonicalHeight_iff` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:113` |
| `PaperC.SectionElevenPartition.sectorOf_eq_smallPrimeProduct_iff` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:99` |
| `PaperC.SectionElevenPartition.sectorOf_eq_terminal_iff` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:198` |
| `PaperC.SectionElevenPartition.sectorPopulations_disjoint` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:235` |
| `PaperC.SectionElevenPartition.seven_sector_populations_cover` | inconditionnel | — | — | — | `PaperC/Combinatorics/SectionElevenPartition.lean:255` |
...
| `PaperC.TheoremEightAlignedClosure.alignedHammingNumerics_eventually` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremEightAlignedClosure.lean:258` |
...
| `PaperC.TheoremEightAlignedClosure.no_aligned_deep_core_eventually` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremEightAlignedClosure.lean:284` |
...
| `PaperC.TheoremEightHammingBudget.componentHammingRadius_conditions_runLengthWindow_eventually` | inconditionnel | — | — | — | `PaperC/Coding/TheoremEightHammingBudget.lean:561` |
| `PaperC.TheoremEightHammingBudget.exists_nonzero_kernel_word_of_component_density` | inconditionnel | — | — | — | `PaperC/Coding/TheoremEightHammingBudget.lean:580` |
...
| `PaperC.TheoremSixteenTwo.abs_globalMean_sub_retainedMean_eq_deepMass` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremSixteenTwo.lean:793` |
| `PaperC.TheoremSixteenTwo.abs_mass_zero_sub_le_two_mul_natTotalVariation` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremSixteenTwo.lean:1168` |
| `PaperC.TheoremSixteenTwo.boundedFullStartLaw_eq_retainedStartLaw` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremSixteenTwo.lean:863` |
| `PaperC.TheoremSixteenTwo.boundedFullStartMean_eq_retainedStartMean` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremSixteenTwo.lean:885` |
| `PaperC.TheoremSixteenTwo.boundedFullStartRate_eq_retainedStartRate` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremSixteenTwo.lean:908` |
| `PaperC.TheoremSixteenTwo.boundedRatioBlock_div_eq_retainedStartIndices` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremSixteenTwo.lean:829` |
| `PaperC.TheoremSixteenTwo.boundedRatioCutoff_le_globalCylinderCutoff` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremSixteenTwo.lean:837` |
| `PaperC.TheoremSixteenTwo.commonCylinderStartProbability_eq_globalStartProbability` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremSixteenTwo.lean:747` |
| `PaperC.TheoremSixteenTwo.criticalScale_le_balanceConstant` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremSixteenTwo.lean:1083` |
| `PaperC.TheoremSixteenTwo.criticalScale_nonneg` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremSixteenTwo.lean:1158` |
...
| `PaperC.TheoremSixteenTwo.discardedStartMass_eq_deepStartProbabilityMass` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremSixteenTwo.lean:770` |
...
| `PaperC.TheoremSixteenTwo.lowerBalanceConstant_le_criticalScale` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremSixteenTwo.lean:1104` |
| `PaperC.TheoremSixteenTwo.lowerBalanceConstant_pos` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremSixteenTwo.lean:1098` |
...
| `PaperC.TheoremSixteenTwo.natTotalVariation_global_retained_le_deepMass` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremSixteenTwo.lean:783` |
...
| `PaperC.TheoremSixteenTwo.poissonPMFReal_zero_eq_exp_neg` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremSixteenTwo.lean:1206` |
...
| `PaperC.TheoremSixteenTwo.retained_window_le_boundedRatioCutoff` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremSixteenTwo.lean:852` |
| `PaperC.TheoremSixteenTwo.startAt_assemble_iff_local` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremSixteenTwo.lean:596` |
| `PaperC.TheoremSixteenTwo.startAt_sampleSpaceEquivLocalProd_iff` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremSixteenTwo.lean:645` |
...
| `PaperC.TheoremSixteenTwo.theorem_sixteen_two` | conditionnel | `ADGR07-PNT`, `AGG89-T1-finite-dependency-b3-zero`, `BS93-Theorem-1`, `ES86-T1b-Q-split-n2`, `LS04-Corollary-1`, `PCv07c-L17.26-bounded-ratio-many-defects`, `PCv07c-L17.28-bounded-ratio-nonterminal-sector`, `PCv07c-L17.30-bounded-ratio-terminal-sector`, `PCv07c-L9.2-generalized-Pell` | `external`, `internal` | `discharged`, `open` | `PaperC/Asymptotics/TheoremSixteenTwo.lean:1618` |
| `PaperC.TheoremSixteenTwo.theorem_sixteen_two_canonical` | conditionnel | `ADGR07-PNT`, `AGG89-T1-finite-dependency-b3-zero`, `BS93-Theorem-1`, `ES86-T1b-Q-split-n2`, `LS04-Corollary-1`, `NR83-T1-divisor-log-bound` | `external` | `open` | `PaperC/Asymptotics/TheoremSixteenTwo.lean:1683` |
...
| `PaperC.TheoremSixteenTwo.two_le_of_mem_retainedStartIndices` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremSixteenTwo.lean:843` |
| `PaperC.TheoremSixteenTwo.two_pow_le_of_two_le_div` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremSixteenTwo.lean:1072` |
| `PaperC.TheoremSixteenTwo.uniformEventProbability_startAt_cutoff_invariant` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremSixteenTwo.lean:708` |
| `PaperC.TheoremSixteenTwo.valueBit_assemble_eq_local` | inconditionnel | — | — | — | `PaperC/Asymptotics/TheoremSixteenTwo.lean:558` |
...
| `PaperC.TreeBoundary.boundaryMap_bijective_of_isTree` | inconditionnel | — | — | — | `PaperC/Combinatorics/TreeBoundary.lean:408` |
| `PaperC.TreeBoundary.boundaryMap_surjective_of_connected` | inconditionnel | — | — | — | `PaperC/Combinatorics/TreeBoundary.lean:303` |
...
| `PaperC.TreeBoundary.boundary_trailEdges` | inconditionnel | — | — | — | `PaperC/Combinatorics/TreeBoundary.lean:148` |
| `PaperC.TreeBoundary.card_edgeSubset_eq_evenVertexSubset` | inconditionnel | — | — | — | `PaperC/Combinatorics/TreeBoundary.lean:394` |
| `PaperC.TreeBoundary.card_evenVertexSubset` | inconditionnel | — | — | — | `PaperC/Combinatorics/TreeBoundary.lean:386` |
| `PaperC.TreeBoundary.deleteRoot_evenCompletion` | inconditionnel | — | — | — | `PaperC/Combinatorics/TreeBoundary.lean:350` |
| `PaperC.TreeBoundary.edgeFinset_fromEdgeSet_eq` | inconditionnel | — | — | — | `PaperC/Combinatorics/TreeBoundary.lean:39` |
| `PaperC.TreeBoundary.edgeValueFinset_subset_edgeFinset` | inconditionnel | — | — | — | `PaperC/Combinatorics/TreeBoundary.lean:271` |
| `PaperC.TreeBoundary.edgeValueFinset_toEdgeSubset` | inconditionnel | — | — | — | `PaperC/Combinatorics/TreeBoundary.lean:284` |
| `PaperC.TreeBoundary.evenCompletion_deleteRoot` | inconditionnel | — | — | — | `PaperC/Combinatorics/TreeBoundary.lean:361` |
...
| `PaperC.TreeBoundary.existsUnique_edgeSubset_boundary_eq` | inconditionnel | — | — | — | `PaperC/Combinatorics/TreeBoundary.lean:423` |
| `PaperC.TreeBoundary.exists_edgeSubset_boundary_eq_of_connected` | inconditionnel | — | — | — | `PaperC/Combinatorics/TreeBoundary.lean:167` |
...
| `PaperC.TreeBoundary.mem_edgeValueFinset` | inconditionnel | — | — | — | `PaperC/Combinatorics/TreeBoundary.lean:257` |
| `PaperC.TreeBoundary.mem_nonRootValueFinset` | inconditionnel | — | — | — | `PaperC/Combinatorics/TreeBoundary.lean:324` |
| `PaperC.TreeBoundary.nonRootValueFinset_deleteRoot` | inconditionnel | — | — | — | `PaperC/Combinatorics/TreeBoundary.lean:334` |
| `PaperC.TreeBoundary.odd_card_symmDiff_iff` | inconditionnel | — | — | — | `PaperC/Combinatorics/TreeBoundary.lean:87` |
| `PaperC.TreeBoundary.root_not_mem_nonRootValueFinset` | inconditionnel | — | — | — | `PaperC/Combinatorics/TreeBoundary.lean:330` |
...
| `PaperC.abs_touchingProbability_sub_baseline_le` | inconditionnel | — | — | — | `PaperC/Probability/TouchingProbability.lean:130` |
