...
$Y_M^\sharp$. To force a type $(e,\sigma)$, modify only the pivots of
its $L+e+2$ raw vertices, including both boundaries; the unused pivots
of the maximal support remain unchanged. This produces the
\emph{entire} law conditioned on that prescribed signed word. It leaves the nonpivot law, including the small-prime environment,
