...
The uniform polynomial-height count below is a classical Pell estimate;
see \cite[arXiv text, Lemma~4]{CillerueloGaraev2011} and
\cite[Lemma~2.10 and Remark~2.12]{Tao2026}.
For comparison with $x^2-Dy^2=E$, multiply $Az^2-Cw^2=e$ by $A$
and set $x=Az$, $D=AC$, $E=Ae$. The nonsquare and polynomial-height
conditions are preserved. The proof below is retained to expose its
uniformity, not as a claim that this counting result is new.
