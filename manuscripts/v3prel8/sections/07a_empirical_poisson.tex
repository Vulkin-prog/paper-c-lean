...
if $|u-v|\ge h_k$. For the other pairs their covariance has absolute
value at most $1/4$. Counting at most $N_k(2h_k-1)$ ordered pairs gives
\[
 \Var(F_{k,r})\le\frac{2h_k-1}{4N_k}\ll\frac{h_k}{n_k},
\]
uniformly in $r$. In particular, overlapping windows have not been
