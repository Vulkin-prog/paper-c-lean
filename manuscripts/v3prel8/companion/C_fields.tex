...
For $0\le I\le V_N$, set $F_I(w)=2D(H/w)-w-I$. Since $D'=u>0$,
\[
 F_I'(w)=-1-\frac{2H}{w^2}u(H/w)<0.
\]
Its endpoint values on $[V_N,\widehat V_N]$ are $V_N-I$ and $-I$.
...
\[
 -1<w_N'(I)=
 -\left(1+\frac{2H}{w_N(I)^2}u(H/w_N(I))\right)^{-1}<0.
\]
Thus $w_N(I)>\widehat V_N-I$ for $I>0$, giving the claimed strict
improvement of the leading budget over $\widehat V_N/2-I$.
